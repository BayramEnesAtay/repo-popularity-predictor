...
## Veri Seti (Dataset)
Projede kullanılan veri seti **Kaggle** platformundan temin edilmiştir. [AI Engineering GitHub Repositories](https://www.kaggle.com/datasets/mansiaggarwal88/ai-engineering-github-repositories) kullanılarak GitHub üzerindeki açık kaynak projelerine ait meta veriler (programlama dili, etiketler, yazılım bağımlılıkları, repoya ait dokümantasyon bilgileri vb.) analiz edilmiştir. Bu veri seti, modelin eğitilmesi ve test edilmesi için temel kaynak olarak kullanılmıştır. GitHub üzerindeki açık kaynak projelerine ait meta verileri (programlama dili, etiketler, yazılım bağımlılıkları, repoya ait dokümantasyon bilgileri vb.) barındıran bu veri seti, modelin eğitilmesi ve test edilmesi için temel kaynak olarak kullanılmıştır.
